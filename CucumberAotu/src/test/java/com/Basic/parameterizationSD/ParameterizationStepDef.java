...
public void  User_checks_Email_address_field(String userEmailAddress ) throws InterruptedException {
 ...
 public void user_enters_title_and_user_first_name(String userfirstName) throws InterruptedException {
	 Thread.sleep(4000);
	 mydriver.findElement(By.xpath("//input[@id='customer_firstname']")).sendKeys(userfirstName);
